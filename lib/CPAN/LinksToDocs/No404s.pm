package CPAN::LinksToDocs::No404s;
...
CPAN::LinksToDocs::No404s - get links to http://search.cpan.org documentation by giving short "tags" and make sure all of them point to existant documentation
...
The module is similiar to L<CPAN::LinksToDocs> module, except this one
...
set to whatever C<CPAN::LinksToDocs::No404s>' C<timeout> argument is
...
Below are the known tags for CPAN::LinksToDocs::No404s module:
...
Please report any bugs or feature requests to C<bug-cpan-linkstodocs-no404s at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=CPAN-LinksToDocs-No404s>.  I will be notified, and then you'll
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc CPAN::LinksToDocs::No404s
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=CPAN-LinksToDocs-No404s>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/CPAN-LinksToDocs-No404s>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/CPAN-LinksToDocs-No404s>

=item * Search CPAN

L<http://search.cpan.org/dist/CPAN-LinksToDocs-No404s>
